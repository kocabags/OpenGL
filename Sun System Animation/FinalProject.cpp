...
const char *WINDOWTITLE = { "Final Project -- Sarp Kocabagli" };
...
Display( )
{
    ...
    glTranslatef(7 +(cos((Time * 360)*PI)/20000), 0, 0);
	glRotatef(Time * 360 *5, 0. , 1., 0.); 
    glEnable(GL_TEXTURE_2D);
	...
	glRotatef(Time * 360, 0.0, 1.0, 0.0);
	glTranslatef(7 + (cos((Time * 360)*PI)/180), 0, 0);
	glRotatef( (Time) * 360, 0.0, 1.0, 0.0);
    //transkate it for distance
	glTranslatef(2, 0, 0);
    glEnable(GL_TEXTURE_2D);
	glBindTexture(GL_TEXTURE_2D, MoonTex);
	MjbSphere(0.25, 100, 100);
	glDisable(GL_TEXTURE_2D);
	...
	glRotatef(Time * 360, 0. , 1., 0.); 
    glTranslatef(6 +(cos((Time * 360)*PI)/20000), 0, 0);
	glRotatef(Time * 360 *5, 0. , 1., 0.); 
    glEnable(GL_TEXTURE_2D);
	glBindTexture(GL_TEXTURE_2D, WorldTex);
	MjbSphere(1, 100, 100);
	...
	glRotatef(Time * 360, 0.0, 1.0, 0.0);
	glTranslatef(6 + (cos((Time * 360)*PI)/180), 0, 0);
	glRotatef( (Time) * 360, 0.0, 1.0, 0.0);
    //translate it for distance
	glTranslatef(2, 0, 0);
    glEnable(GL_TEXTURE_2D);
	glBindTexture(GL_TEXTURE_2D, MoonTex);
	MjbSphere(0.25, 100, 100);
	...
	glPushMatrix();
	glRotatef(Time * 360, 0.0, 1.0, 0.0); 
    glTranslatef(15 +(cos((Time * 360)*PI)/180), 0, 0);
	glRotatef(Time * 360 , 0.0, 1.0, 0.0);
    ...
    glPushMatrix();
	glRotatef(Time * 360, 0.0, 1.0, 0.0);
	glTranslatef(-5 + (sin((Time * 360)*PI)/90), 0, 0);
	// glRotatef( (Time * 5) * 360, 0.0, 1.0, 0.0);
    glEnable(GL_TEXTURE_2D);
	glBindTexture(GL_TEXTURE_2D, MoonTex);
	MjbSphere(0.25, 100, 100);
	glDisable(GL_TEXTURE_2D);
...
void BindidngTextures ( ) 
{
	...
	glTexImage2D( GL_TEXTURE_2D, 0, 3, SWidth, SHeight, 0, GL_RGB, GL_UNSIGNED_BYTE, SunTexture );
	...
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
	glTexImage2D( GL_TEXTURE_2D, 0, 3, WWidth, WHeight, 0, GL_RGB, GL_UNSIGNED_BYTE, WorldTexture );
	...
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
	glTexImage2D( GL_TEXTURE_2D, 0, 3, MWidth, MHeight, 0, GL_RGB, GL_UNSIGNED_BYTE, MoonTexture );
...
InitGraphics( )
{
    ...
    WorldTexture = BmpToTexture ("worldtex.bmp", &WWidth , &WHeight );
    SunTexture = BmpToTexture ("suntex.bmp", &SWidth , &SHeight );
    MoonTexture = BmpToTexture ("moontex.bmp" , &MWidth , &MHeight );
